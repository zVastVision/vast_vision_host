...
const NuxtServerComponent = defineComponent({
  ...
  async setup(props, { slots }) {
    ...
    const html = computed(() => {
      ...
      return res.data.value.html.replace(UID_ATTR, () => `nuxt-ssr-component-uid="${randomUUID()}"`).replace(SLOT_FALLBACK_RE, (full, slotName, content) => {
    ...
    function setUid() {
      uid.value = html.value.match(SSR_UID_RE)?.[1] ?? randomUUID();
    }
    await res;
